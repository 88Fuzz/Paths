 ...
 */
int SceneNode::get1d(int x, int y, int width)
{
    return width * y + x;
}
...
std::vector<SceneNode *>::iterator SceneNode::getChildIteratorBegin()
{
    return children.begin();
}

std::vector<SceneNode *>::iterator SceneNode::getChildIteratorEnd()
{
    return children.end();
}
